...
// ─── Member list cache (per team, refreshes every 10 minutes) ────────────────
// Avoids hammering users.list on every message and hitting Slack rate limits.
...
async function getCachedMembers(client, teamId, excludeId) {
  ...
  console.log(`🔄 Refreshed member cache for team ${teamId}: ${members.length} members`);
