...
async function reachOutToNext(client, teamId, request) {
  ...
  const result = await think(
    ...
    "Shift: " + (shiftDetails && shiftDetails.date || "") + " " + (shiftDetails && shiftDetails.time || "") + (shiftDetails && shiftDetails.role ? ", " + shiftDetails.role : "") + (shiftDetails && shiftDetails.reason ? ". Reason: " + shiftDetails.reason : "") + ".\n" +
    "1-2 sentences. Sound like a real person texting a coworker.\n\n" +
    "Example: 'Hey, any chance you could cover my shift this Saturday 9am-5pm? Would really appreciate it!'\n\n" +
