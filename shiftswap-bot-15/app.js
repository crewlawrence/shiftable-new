      ...
      success: (installation, installOptions, req, res) => {
        res.send(`
          <html><body style="font-family:sans-serif;text-align:center;padding:60px">
            ...
            <p>Head back to Slack and DM <strong>Shiftable AI</strong> to get started.</p>
          </body></html>
        `);
      },
...
receiver.router.get("/", (req, res) => {
  ...
  res.send(`
    ...
    <body>
      <div class="card">
        <h1>🔄 Shiftable AI</h1>
        <p>Need someone to cover your shift? Just DM the Agent, tell it your shift details, and it'll reach out to your teammates one by one until someone says yes.</p>
